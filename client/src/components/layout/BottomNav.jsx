    ...
    <>
          ...
          >
            <div className="flex items-center justify-between pb-2 border-b border-slate-800">
              ...
              <button 
                type="button"
                onClick={() => setShowAddMenu(false)}
                className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl bg-slate-800/80 text-slate-400 active:text-white active:scale-95 transition cursor-pointer"
              >
      ...
      >
        ...
        <NavLink
          to="/dashboard"
          onClick={() => setShowAddMenu(false)}
          className={`flex-1 h-full min-h-[52px] py-2 px-1 flex flex-col items-center justify-center rounded-full transition-all duration-150 cursor-pointer touch-manipulation active:scale-95 relative ${
