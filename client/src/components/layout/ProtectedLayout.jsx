...
export default function ProtectedLayout() {
  ...
  return (
    <div className="h-full h-[100dvh] w-full bg-slate-950 text-slate-100 flex flex-col lg:flex-row overflow-hidden">
      <Sidebar />
      <main className="flex-1 lg:pl-64 h-full w-full overflow-y-auto overflow-x-hidden pt-[calc(4.25rem+env(safe-area-inset-top,0px))] pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] lg:pt-0 lg:pb-8 relative z-0">
